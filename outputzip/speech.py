...
def skill_launch():
    speech = "<speak>Welcome to the Sight Support Alexa Hub. <break time='250ms'/>For tomorrow's evemts. say 'Tomorrow'. For this week's events, say 'this week'. <break time='250ms'/>For this month's events, say 'this month'</speak>"
